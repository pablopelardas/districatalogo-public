<template>
  <Transition name="whatsapp-float">
    ...
    >
      <!-- Button -->
      <div class="relative">
        <div class="flex items-center justify-center w-14 h-14 bg-green-500 rounded-full shadow-lg group-hover:shadow-xl transform group-hover:scale-110 transition-all duration-300">
          <svg
